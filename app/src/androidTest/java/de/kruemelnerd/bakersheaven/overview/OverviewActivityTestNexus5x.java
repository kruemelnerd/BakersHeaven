...
public class OverviewActivityTestNexus5x {
    ...
    public void overviewActivityTestNexus5x() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.overview_recipe_title), withText("Brownies"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class),
                                        0),
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.overview_recipe_title), withText("Yellow Cake"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class),
                                        0),
        ...
        ViewInteraction textView4 = onView(
                allOf(withId(R.id.overview_recipe_title), withText("Cheesecake"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class),
                                        0),
